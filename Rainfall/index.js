...
class Particle {
    constructor() {
        ...
        this.y = 0;
        this.brightness = 0;
        this.velocity = Math.random() * 3 + 0.01;
    ...
    draw() {
        ctx.beginPath();
        ctx.fillStyle = rbgArray[Math.floor(this.y - 1) * canvas.width + Math.floor(this.x)];
...
img.onload = function () {
    ...
    for (let i = 0; i < imgData.data.length; i++) {
        ...
        //with rgb 
        rbgArray.push(`rgb(${red}, ${green}, ${blue} )`);
